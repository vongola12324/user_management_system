...
// @edit: Davy
// @lastedit: 2012/04/07 07:26 GMT+8
...
(function($) {
    $.fn.ajaxfileupload = function(options) {
        ...
        return this.each(function() {
          ...
          {
            if($element.val() == '') return settings.onEmpty.apply($element, [settings.params]);
            ...
            if($.inArray(ext, settings.valid_extensions) == -1)
            {
              ...
              settings.onTypeNotMatch.apply($element, [settings.params]);
            } else
            { 
              uploading_file = true;
